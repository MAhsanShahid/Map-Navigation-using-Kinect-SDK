...
namespace WPFKinectSDK18
{
    ...
    public partial class MainWindow : Window
    {
        ...
        string mapKey = ConfigurationManager.AppSettings["mapKey"].ToString();
   ...
   //.........................................................Speech..........................................................
    ...
    GeoPositionChangedEventArgs<GeoCoordinate> e)
        ...
        string GET(int poi, double lat, double lon)
            ...
            string url = "http://spatial.virtualearth.net/REST/v1/data/c2ae584bbccc4916a0acf75d1e6947b4/NavteqEU/NavteqPOIs?spatialFilter=nearby(" + lat + "," + lon + ",5)&$filter=EntityTypeID%20eq%20%27" + poi + "%27&key="+mapKey;
        ...
        
        {
                ...
                //51.509865,-0.118092
                string url = "http://dev.virtualearth.net/REST/V1/Routes?wp.0=" + latitude + "," + longitude + "&wp.1=" + city + "&key="+mapKey;
                HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
                try
                {
                    WebResponse response = request.GetResponse();
